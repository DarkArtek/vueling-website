...
export const NavBar = () => {
    ...
    return (
        <nav className={`fixed z-50 w-full ${scroll || isOpen ? 'bg-vueling-dark shadow-lg-dark transition' : 'bg-transparent transition'}`} onClick={handleClick}>
            <Container className="p-4">
                <div className="flex justify-between space-x-4">
                    <Link href="/">
                        <Image className="cursor-pointer" src="/svg/logo.svg" width={150} height={40} alt="logo"></Image>
                    </Link>
